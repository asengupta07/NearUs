    ...
    const NoNotificationsMessage = () => (
        ...
        >
            ...
            >
                <span className="absolute inset-[-1000%] animate-[spin_2s_linear_infinite] bg-[conic-gradient(from_90deg_at_50%_50%,#E2CBFF_0%,#393BB2_50%,#E2CBFF_100%)]" />
                <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-slate-950 px-3 py-1 text-sm font-medium text-white backdrop-blur-3xl">
                    Create Some Buzz <Bell className="ml-2 h-5 w-5" />
                </span>
            </Button> */}
        </motion.div>
    )
                    ...
                    <main className="grid grid-cols-1 md:grid-cols-3 gap-6 flex-grow">
                        ...
                        <div className="md:col-span-2 space-y-6 flex flex-col">
                                        ...
                                        <motion.ul className="space-y-4">
                                            {notifications.map((notification, index) => (
                                                <motion.li
                                                    ...
                                                    className={`flex items-center p-3 rounded-lg ${notification.read ? 'bg-gray-800' : 'bg-gray-700'
                                                        }`}
                                                >
                                                    <div className="mr-3">
                            ...
                            <Card className="flex-grow bg-gray-900 border-none">
                                ...
                                <CardContent className="overflow-y-auto custom-scrollbar p-0 pt-3 px-6 pb-3">
